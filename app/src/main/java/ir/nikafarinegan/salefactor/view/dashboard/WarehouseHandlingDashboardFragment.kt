...
class WarehouseHandlingDashboardFragment: BaseFragment(){
    ...
    private fun getItems() {
        ...
        val subSystemId = Const.SubSystems.KEY_WAREHOUSE_HANDLING
    ...
    companion object {
        val TAG = "${Const.APP_NAME}: ${WarehouseHandlingDashboardFragment::class.java.simpleName}"
    }
}