...
class OperationDashboardFragment : BaseFragment() {
    ...
    private fun getItems() {
        ...
        val subSystemId = Const.SubSystems.KEY_OPERATION
    ...
    private fun gotoOperation(ssId: Int, name: String) {
        val intent = Intent(activity, DocumentActivity::class.java)
        intent.putExtra(KEY_ITEM_NAME, name)
    ...
    companion object {
        val TAG = "${Const.APP_NAME}: ${OperationDashboardFragment::class.java.simpleName}"
    }
}